Rất đơn giản..
Bạn đưa cái phần bỏ vào temp nhét vào Widget hoặc Annoucement hay Generalities là okay thôi

Cụ thể:
Bạn nhét cái này vào CSS:
...
Nhét cái này vào Widget (hoặc Annoucement hoặc Generalities):
...
P/s: Lần sau nhữg bài như thế này là thuộc box Nhờ Convert Code, TUT rồi bạn nhé Smile
Lần này mình move cho. Lần sau sẽ sọt thẳng nhé Smile
