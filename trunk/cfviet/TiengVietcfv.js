...
function AVIM()	{
	...
	this.db1 = [273,272];
	this.ds1 = ['d','D'];
	this.os1 = "o,O,Æ¡,Æ ,Ã³,Ã“,Ã²,Ã’,á»,á»Œ,á»,á»Ž,Ãµ,Ã•,á»›,á»š,á»,á»œ,á»£,á»¢,á»Ÿ,á»ž,á»¡,á» ".split(",");
	this.ob1 = "Ã´,Ã”,Ã´,Ã”,á»‘,á»,á»“,á»’,á»™,á»˜,á»•,á»”,á»—,á»–,á»‘,á»,á»“,á»’,á»™,á»˜,á»•,á»”,á»—,á»–".split(",");
	this.mocs1 = "o,O,Ã´,Ã”,u,U,Ã³,Ã“,Ã²,Ã’,á»,á»Œ,á»,á»Ž,Ãµ,Ã•,Ãº,Ãš,Ã¹,Ã™,á»¥,á»¤,á»§,á»¦,Å©,Å¨,á»‘,á»,á»“,á»’,á»™,á»˜,á»•,á»”,á»—,á»–".split(",");
	this.mocb1 = "Æ¡,Æ ,Æ¡,Æ ,Æ°,Æ¯,á»›,á»š,á»,á»œ,á»£,á»¢,á»Ÿ,á»ž,á»¡,á» ,á»©,á»¨,á»«,á»ª,á»±,á»°,á»­,á»¬,á»¯,á»®,á»›,á»š,á»,á»œ,á»£,á»¢,á»Ÿ,á»ž,á»¡,á» ".split(",");
	this.trangs1 = "a,A,Ã¢,Ã‚,Ã¡,Ã,Ã ,Ã€,áº¡,áº ,áº£,áº¢,Ã£,Ãƒ,áº¥,áº¤,áº§,áº¦,áº­,áº¬,áº©,áº¨,áº«,áºª".split(",");
	this.trangb1 = "Äƒ,Ä‚,Äƒ,Ä‚,áº¯,áº®,áº±,áº°,áº·,áº¶,áº³,áº²,áºµ,áº´,áº¯,áº®,áº±,áº°,áº·,áº¶,áº³,áº²,áºµ,áº´".split(",");
	this.as1 = "a,A,Äƒ,Ä‚,Ã¡,Ã,Ã ,Ã€,áº¡,áº ,áº£,áº¢,Ã£,Ãƒ,áº¯,áº®,áº±,áº°,áº·,áº¶,áº³,áº²,áºµ,áº´,áº¿,áº¾,á»,á»€,á»‡,á»†,á»ƒ,á»‚,á»…,á»„".split(",");
	this.ab1 = "Ã¢,Ã‚,Ã¢,Ã‚,áº¥,áº¤,áº§,áº¦,áº­,áº¬,áº©,áº¨,áº«,áºª,áº¥,áº¤,áº§,áº¦,áº­,áº¬,áº©,áº¨,áº«,áºª,Ã©,Ã‰,Ã¨,Ãˆ,áº¹,áº¸,áº»,áºº,áº½,áº¼".split(",");
	this.es1 = "e,E,Ã©,Ã‰,Ã¨,Ãˆ,áº¹,áº¸,áº»,áºº,áº½,áº¼".split(",");
	this.eb1 = "Ãª,ÃŠ,áº¿,áº¾,á»,á»€,á»‡,á»†,á»ƒ,á»‚,á»…,á»„".split(",");
	this.english = "ÄÃ‚Ä‚Æ Æ¯ÃŠÃ”";
	this.lowen = "Ä‘Ã¢ÄƒÆ¡Æ°ÃªÃ´";
	this.arA = "Ã¡,Ã ,áº£,Ã£,áº¡,a,Ã,Ã€,áº¢,Ãƒ,áº ,A".split(',');
	this.mocrA = "Ã³,Ã²,á»,Ãµ,á»,o,Ãº,Ã¹,á»§,Å©,á»¥,u,Ã“,Ã’,á»Ž,Ã•,á»Œ,O,Ãš,Ã™,á»¦,Å¨,á»¤,U".split(',');
	this.erA = "Ã©,Ã¨,áº»,áº½,áº¹,e,Ã‰,Ãˆ,áºº,áº¼,áº¸,E".split(',');
	this.orA = "Ã³,Ã²,á»,Ãµ,á»,o,Ã“,Ã’,á»Ž,Ã•,á»Œ,O".split(',');
	this.aA = "áº¥,áº§,áº©,áº«,áº­,Ã¢,áº¤,áº¦,áº¨,áºª,áº¬,Ã‚".split(',');
	this.oA = "á»‘,á»“,á»•,á»—,á»™,Ã´,á»,á»’,á»”,á»–,á»˜,Ã”".split(',');
	this.mocA = "á»›,á»,á»Ÿ,á»¡,á»£,Æ¡,á»©,á»«,á»­,á»¯,á»±,Æ°,á»š,á»œ,á»ž,á» ,á»¢,Æ ,á»¨,á»ª,á»¬,á»®,á»°,Æ¯".split(',');
	this.trangA = "áº¯,áº±,áº³,áºµ,áº·,Äƒ,áº®,áº°,áº²,áº´,áº¶,Ä‚".split(',');
	this.eA = "áº¿,á»,á»ƒ,á»…,á»‡,Ãª,áº¾,á»€,á»‚,á»„,á»†,ÃŠ".split(',');
	this.oA = "á»‘,á»“,á»•,á»—,á»™,Ã´,á»,á»’,á»”,á»–,á»˜,Ã”".split(',');
...
//        document.write('</div>');
	...
	this.ckspell = function(w, k) {
		...
		var noNHE = "O,U,IE,Ã”,Æ ,Æ¯,IÃŠ,Ä‚,Ã‚,UYE,UYÃŠ,UO,Æ¯Æ ,Æ¯O,UÆ ,UA,Æ¯A,OÄ‚,OE,OÃŠ".split(','),oMoc = "UU,UOU".split(',');
	...
	this.findC = function(w, k, sf) {
		...
		var str = "", res, cc = "", pc = "", tE = "", vowA = [], s = "Ã‚Ä‚ÃŠÃ”Æ Æ¯ÃªÃ¢ÄƒÆ¡Ã´Æ°", c = 0, dn = false, uw = this.up(w), tv, g;
		...
		var uk = this.up(k), uni_array = this.repSign(k), w2 = this.up(this.unV2(this.unV(w))), dont = "Æ¯A,Æ¯U".split(',');
			...
			if(!res) {
				for(g = 1; g <= w.length; g++) {
					...
					if(str.indexOf(uc) >= 0) {
						...
						if(!this.whit || (uw.indexOf("Æ¯") < 0) || (uw.indexOf("W") < 0)) {
							break;
						}
	...
	this.ie_replaceChar = function(w, pos, c) {
		...
		if(this.whit && (this.up(w.substr(w.length - pos - 1, 1)) == 'U') && (pos != 1) && (this.up(w.substr(w.length - pos - 2, 1)) != 'Q')) {
			this.whit = false;
			if((this.up(this.unV(this.fcc(c))) == "Æ ") || (uc == "O")) {
	...
	this.up = function(w) {
		w = w.toUpperCase();
		if(this.isKHTML) {
			var str = "ÃªÃ´Æ¡Ã¢ÄƒÆ°áº¿á»‘á»›áº¥áº¯á»©á»á»“á»áº§áº±á»«á»…á»—á»¡áº«áºµá»¯á»‡á»™á»£áº­áº·á»±", rep="ÃŠÃ”Æ Ã‚Ä‚Æ¯áº¾á»á»šáº¤áº®á»¨á»€á»’á»œáº¦áº°á»ªá»„á»–á» áºªáº´á»®á»†á»˜á»¢áº¶á»°", z, io;
