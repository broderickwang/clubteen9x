...
function resizeimg() {
  if (document.getElementsByTagName) {
    for (i=0; i<document.getElementById('page-body').getElementsByTagName('img').length; i++){
      ...
      if (im.width > 400){
        eval("pop" + String(i) + " = new Function(\"pop = jQuery.slimbox('" + im.src + "', 'www.cfviet.co.cc'); pop.focus();\")");
...
if(IE6){
	...
	$(function(){
		...
		$("<div><img src='http://ca5.upanh.com/15.951.20244423.qIN0/ie6.jpg' alt='' style='float: left;'/><p><br /><strong><font color='black'>Sorry! CFviet doesn't support Internet Explorer 6.</strong><br /><br />If you'd like to read our content please <a href='http://www.mozilla.com'>upgrade your browser to Firefox</a> now.</font></p>")
			.css({
