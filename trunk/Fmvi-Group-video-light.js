$(document).ready(function(){
    $('.postbody embed[src*=youtube],.postbody embed[src*=dailymotion]').wrap("<table style='background:#addffa;border: 1px solid #1E517C;padding: 5px 5px 5px 5px;' align='center'><tr class='FMvi-video'><td align='left'></td></tr></table>");
    $('<tr><td style="background:#211c10 url(http://diendan.thegioihoanmy.vn/images/ttnn/gradients/gradient_tcat.gif);font:bold 11px tahoma;color:#FFF;text-align:center; text-shadow:green 0.1em 0.1em 0.2em;padding:0px;" align="left" height="30px" width="100%">FMvi-Group<span style="float:right"><img src="http://i28.servimg.com/u/f28/16/48/23/13/fixed-10.png" alt="" border="0" /><img src="http://i28.servimg.com/u/f28/16/48/23/13/fixed-11.png" alt="" border="0" /></span><span style="float:right"><img src="http://diendan.thegioihoanmy.vn/images/ttnn/buttons/collapse_tcat.gif" alt="" border="0" /><img src="http://diendan.thegioihoanmy.vn/images/ttnn/buttons/collapse_tcat_collapsed.gif" alt="" border="0" /></span></td></tr>').insertBefore('.FMvi-video');
