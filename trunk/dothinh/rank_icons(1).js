...
// Helpline messages
b_help = "Ch? d?m : [b]text[/b] (alt+b)";
i_help = "Ch? nghiêng : [i]text[/i] (alt+i)";
u_help = "G?ch du?i : [u]text[/u] (alt+u)";
q_help = "Trích d?n : [quote]text[/quote] (alt+q)";
c_help = "Hi?n th? Code : [code]code[/code] (alt+c)";
l_help = "Danh sách : [list]text[/list] (alt+l)";
o_help = "S?p x?p danh sách : [list=]text[/list] (alt+o)";
p_help = "Chèn hình ?nh : [img]http://image_url[/img]";
w_help = "Chèn URL : [url]http://url[/url] or [url=http://url]URL text[/url] (alt+w)";
a_help = "Ðóng t?t c? các th? bbCode dang m?";
s_help = "Màu font : [color=red]text[/color] Có th? dùng color=#FF0000";
f_help = "Kích thu?c font : [size=x-small]small text[/size]";
k_help = "Scroll text: [scroll]text[/scroll] (alt+k)";
e_help = "Fade text: [fade]text[/fade] (alt+e)";
r_help = "Blur text: [blur]text[/blur] (alt+r)";
j_help = "Flip text h: [fliph]text[/fliph] (alt+j)";
v_help = "Flip text v: [flipv]text[/flipv] (alt+v)";
m_help = "Text align left: [left]text[/left] (alt+m)";
d_help = "Updown text: [updown]text[/updown] (alt+d)";
t_help = "Text align center: [center]text[/center] (alt+t)";
g_help = "Text align right: [right]text[/right] (alt+g)";
x_help = "Strike text: [strike]text[/strike] (alt+x)";
y_help = "Host an image";
z_help = "Insert a smiley in your message";
h_help = "Visible text by those who have posted in this topic : [hide]text[/hide] (alt+h)";
sp_help = "Hidden text can be displayed by clicking on it : [spoiler]text[/spoiler] (alt+o)";
wo_help = "A World of Warcraft object : [wow]17104[/wow]";
ft_help = "Text font : [font=Verdana]text[/font]";
jt_help = "Justify text : [justify]text[/justify] (alt+j)";
sub_help = "Put as index: [sub]text[/sub] (alt+m)";
sup_help = "Put as exponent: [sup]text[/sup] (alt+n)";
...
function checkForm() {
	...
	if (document.post.message.value.length < 3) {
		formErrors = "B?n chua nh?p n?i dung thông di?p.";
	}
	if (formErrors) {
		return false;
	} else {
...
function insert_search_menu(session_id) {
	...
	document.write('<div id="search_menu" style="display:none;position:absolute;z-index:10000"><form action="/search.forum" method="get"><input type="hidden" name="mode" value="searchbox" /><table class="forumline" cellpadding="3" cellspacing="0" border="0"><tr><th class="thHead">Tìm ki?m</th></tr><tr><td class="row2" align="center"><input type="text" class="post" name="search_keywords" size="24" style="height:20px; margin-top:6px; margin-right:3px;" /> <input type="submit" class="button" value="Go" /></td></tr><tr><td class="row2" align="center" nowrap="nowrap"><span class="genmed">&nbsp;Display results as :&nbsp; <input id="rposts" type="radio" name="show_results" value="posts" /><label for="rposts">&nbsp;S? bài</label> <input id="rtopics" type="radio" name="show_results" value="topics" checked="checked" /><label for="rtopics">&nbsp;Ch? d?</label>&nbsp;</td></tr><tr><td class="row2" align="center"><span class="genmed"><hr><a href="/search.forum'+session_id+'" rel="nofollow"><img src="http://illiweb.com/fa/icon_mini_search.gif" width="12" height="13" border="0" hspace="3" />&nbsp;Advanced Search</a><span></td></tr></table>'+session_input+'</form></div>');
}

function insert_search_menu_new(session_id) {
	session_input = (session_id ? '<input type="hidden" name="sid" value="'+session_id+'" />' : '');
	session_id = (session_id ? '?sid='+session_id : '');
	document.write('<div class="overview row3" id="search_menu" style="display:none;position:absolute;width:350px;z-index:10000"><form action="/search.forum" method="get"><input type="hidden" name="mode" value="searchbox" /><p class="title-overview row2">Tìm ki?m</p><p class="center-overview"><input type="text" class="inputbox medium" name="search_keywords" />'+session_input+'<input type="submit" class="button1" value="Go" /><br />Display results as : <label for="rposts"><input id="rposts" type="radio" name="show_results" value="posts" /> S? bài</label> <label for="rtopics"><input id="rtopics" type="radio" name="show_results" value="topics" checked="checked" /> Ch? d?</label></p><hr class="dashed" /><p class="center-overview"><a href="/search.forum'+session_id+'" rel="nofollow"><img src="http://illiweb.com/fa/icon_mini_search.gif" width="12" height="13" alt="" /> Advanced Search</a></p>'+session_input+'</form></div>');
}
...
function insert_plus_menu(search_where,session_id,add_favourite) {
	...
	if(add_favourite)
	{
		...
		favourite = '<a href="/search.forum?search_id=favouritesearch&amp;add_favourite='+favourite+session_id+'">Add to your favourites</a><br />';
	}
	search_where = '&amp;search_where='+search_where;
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div id="plus_menu" style="display:none;position:absolute;margin-top:8px;z-index:1;"><table class="forumline" cellpadding="3" cellspacing="0" border="0" width="200"><tr><th class="thHead">Actions !</th></tr><tr><td class="row1" nowrap="nowrap"><span class="gensmall"><b><a href="/search.forum?search_id=newposts'+search_where+session_id+'">Xem bài m?i t? l?n truy c?p tru?c</a><br /><a href="/search.forum?search_id=egosearch'+search_where+session_id+'">Xem bài c?a b?n</a><br /><a href="/search.forum?search_id=unanswered'+search_where+session_id+'">Xem bài chua có ai tr? l?i</a><br /><a href="/search.forum?search_id=watchsearch'+search_where+session_id+'">Topic being watched</a><hr>'+favourite+'<a href="/tell_friend.forum?f='+search_where+session_id+'">Send to a friend</a><br /><a href="'+self.location.href+'" onclick="link_bbcode();return false">Copy BBCode URL</a><br /><a href="javascript:void(0);" onclick="window.print();return false">Print this page</a></b></span></td></tr></table></div>');
}
...
function insert_plus_menu_new(search_where,session_id,add_favourite,watch_topic) {
	...
	search_where = '&amp;search_where='+search_where;
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div class="overview row3" id="plus_menu" style="display:none;position:absolute;width:400px;margin-top:8px;z-index:1;"><p class="title-overview row2"><strong>Actions !</strong></p><p class="left-overview"><strong><a href="/search.forum?search_id=newposts'+search_where+session_id+'">Xem bài m?i t? l?n truy c?p tru?c</a><br /><a href="/search.forum?search_id=egosearch'+search_where+session_id+'">Xem bài c?a b?n</a><br /><a href="/search.forum?search_id=unanswered'+search_where+session_id+'">Xem bài chua có ai tr? l?i</a><br /><a href="/search.forum?search_id=watchsearch'+search_where+session_id+'">Topic being watched</a></strong></p><hr class="dashed" /><p class="left-overview"><strong>'+watch+favourite+'<a href="/tell_friend.forum?f='+search_where+session_id+'">Send to a friend</a><br /><a href="'+self.location.href+'" onclick="link_bbcode();return false">Copy BBCode URL</a><br /><a href="javascript:void(0);" onclick="window.print();return false">Print this page</a></strong></p></div>');
}

function insert_plus_album(search_where,session_id) {
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div id="plus_menu" style="display:none;position:absolute;right:100px;z-index:1;"><table class="forumline" cellpadding="3" cellspacing="0" border="0"><tr><th class="thHead">Actions !</th></tr><tr><td class="row1" nowrap="nowrap"><span class="gensmall"><b><a href="/tell_friend.forum?album='+search_where+session_id+'">Send to a friend</a></b></span></td></tr></table></div>');
}

function insert_plus_album_new(search_where,session_id) {
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div class="overview row3" id="plus_menu" style="display:none;margin: 8px 20px 0px 0px;position:absolute;right:20px;width:200px;z-index:1;"><p class="title-overview row2">Actions !</p><p class="left-overview"><strong><a href="/tell_friend.forum?album='+search_where+session_id+'">Send to a friend</a></strong></p></div>');
}

function insert_plus_pic(search_where,session_id) {
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div id="plus_menu" style="display:none;position:absolute;right:100px;z-index:1;"><table class="forumline" cellpadding="3" cellspacing="0" border="0"><tr><th class="thHead">Actions !</th></tr><tr><td class="row1" nowrap="nowrap"><span class="gensmall"><b><a href="/tell_friend.forum?pic='+search_where+session_id+'">Send to a friend</a></b></span></td></tr></table></div>');
}

function insert_plus_pic_new(search_where,session_id) {
	session_id = (session_id ? '&amp;sid='+session_id : '');
	document.write('<a href="javascript:showhide(document.getElementById(\'plus_menu\'))">Actions !</a><br /><div class="overview row3" id="plus_menu" style="display:none;position:absolute;right:20px;margin-top:20px;z-index:1;"><p class="title-overview row2">Actions !</p><p class="left-overview"><strong><a href="/tell_friend.forum?pic='+search_where+session_id+'">Send to a friend</a></strong></p></div>');
}
...
function showMenu (user_id, user_name, my_user_id, my_chat_level, my_user_level, user_chat_level, user_level, event, sid) {
	...
	close.setAttribute('alt', 'Ðóng c?a s? này');
	...
	if (connected && user_id == my_user_id)
	{
		...
		link.setAttribute('href', 'javascript:void(0)');
//		link.onclick = new Function ("return action_user('exit', prompt('Reason',''), '"+sid+"');");
            ...
            if ( index != -1 && ! $(this).data('img_' + current_instance + '_' + index) ){
        		...
        		if ( ( img_width > refs.max_width && refs.max_width != 0 ) || ( img_height > refs.max_height && refs.max_height != 0 ) ) {
        			...
        			if (img_width > max_width){
            		    ...
            		    fullsize_a.href = '#';
            		    $(fullsize_a).bind('click', img_el.src, function(e) { window.open('/viewimage.forum?u=' + encodeURIComponent(e.data)); return false; }).addClass('fullsize').text("Click to see fullsize");
