...
if ((x[i].style.color=="rgb(255, 18, 18)")||(x[i].style.color=="#fa0000")) {newHTML = "<img src=\"http://i21.servimg.com/u/f21/15/61/17/20/admin12.gif\">" + "</img>" + x[i].innerHTML}

else if((x[i].style.color=="rgb(9, 0, 255)")||(x[i].style.color=="#ff6600")) {newHTML = "<img src=\"http://i21.servimg.com/u/f21/15/61/17/20/smod13.gif\">" + "</img>" + x[i].innerHTML}
...
stats="<div align='left'><table cellpadding='0' cellspacing='0' width='170'><tr><td width='150'><br>
<div valign='bottom' style='padding: 3px;'><font color='red' style='font-size: 12px'><b> "+title1+": "+ phansonguyen +"   Л"+medal[nick]+"Ћ</b></font><br><br><font color='blue' size='1'><b> Kinh nghi?m: "+exp+"%</b></font>"+expss+"<font color='orange' size='1'><b> "+title2+": "+ xp[nick]+" / "+maxstrength+"</b></font>"+strengthss+""+"<font color='green' size='1'><b> Danh v?ng: " +xptogo+" / "+maxability+"</b></font>"+abilityss+"</div></td></tr></table></div> "
x[y].innerHTML +=<span class='gensmall'>" + stats} else{x[y].innerHTML +=<font color=red><br><br><b><center>ау h?t points</center></b></font>"}}}
}
