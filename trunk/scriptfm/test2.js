...
document.write('<td align="center" rowspan="100" width="'+barWidth+'" style="background: #fff url(http://i832.photobucket.com/albums/zz244/a1tg3/lylich.jpg) no-repeat top left;" valign="'+barVAlign+'"><p align="center"><font face="'+barFontFamily+'" Size="'+barFontSize+'" COLOR="'+barFontColor+'"><B>'+tempBar+'</B></font></p></TD>')}
