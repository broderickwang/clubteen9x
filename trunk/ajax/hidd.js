...
//msgbox
    var $msgbox = function(o) {
        ...
        var $titleWrapper = $('<div class=msgTips><p> Bạn chưa <span class=tip_highlight>Đăng kí </span>hoặn <span class=tip_highlight>Đăng nhập</span></p><p>Hãy gia nhập cùng chúng tôi</p><p>Thông báo tự đóng sau 5s</p></div><div class=tipBtns><a href=/register class=tipsReg><span>Đăng kí</span></a><a href=/login class=tipsLogin><span>Đăng nhập</span></a></div><div class=timer></div>')
