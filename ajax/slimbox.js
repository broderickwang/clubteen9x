...
function resizeimg() {
  if (document.getElementsByTagName) {
    for (i=0; i<document.getElementById('page-body').getElementsByTagName('img').length; i++){
      ...
      if (im.width > 400){
        eval("pop" + String(i) + " = new Function(\"pop = jQuery.slimbox('" + im.src + "', 'wWw.Friends4u.Ace.St'); pop.focus();\")");
        eval("im.onclick = pop" + String(i) + ";");
        if (document.all) im.style.cursor = 'hand';
        if (!document.all) im.style.cursor = 'pointer';
        im.title = 'Click để xem kích thước thật... ';
      }
      }
      }
	}
...
if(IE6){
	...
	$(function(){
		...
		$("<div><img src='http://i68.servimg.com/u/f68/13/98/42/59/no-ie610.jpg' alt='' style='float: left;'/><p><br /><strong><font color='black'>Xin lỗi! Friends4u không hỗ trợ Internet Explorer 6.</strong><br /><br />Nếu bạn muốn xem nội dung ben trong, làm ơn  <a href='http://www.firefoxsupport.net'>Update trình duyệt bạn thành FireFox</a> ngay bây giờ.</font></p>")
			.css({
