...
Bước 1: Tạo 1 js mới:
Bước tạo thế nào thì ai cũng biết rồi mình không nói lại ở bài này.

Title **: MOD tổng hợp
Placement : không chọn
Javascript Code** :

Download js dưới đây mở ra coppy và gắn nó vào
...
]');$("#profile-advanced-details li:eq("+wXl+") .signature_div").remove()}}var urlpanel=location.pathname+location.search;if(urlpanel=="/profile?mode=editprofile&page_profil=attachments"||urlpanel=="/profile?mode=editprofile&page_profil=friendsfoes"||urlpanel=="/search?search_id=watchsearch"||urlpanel=="/search?search_id=favouritesearch"||urlpanel=="/search?search_id=draftsearch"||urlpanel=="/profile?mode=editprofile&page_profil=facebook"){$("#tabs").remove();$("form.frm-form").parents(".main").wrapInner('<div style="clear: left; float: left; margin: 0 ! important; width: 660px; padding-right: 10px;">

Unknown end tag for &lt;/div&gt;

').after('<div style="float: left; width: 181px;"><div class="module main"><div class="main-head"><div class="h3">Hòm thư cá nhân
...
<div class="main-content"><p><img src="http://hitskin.com/themes/16/32/01/i_msg_inbox.png" /><a href="/privmsg?folder=inbox"> Hộp thư đến
...
<p><img src="http://hitskin.com/themes/16/32/01/i_msg_sentbox.png" /><a href="/privmsg?folder=sentbox"> Hộp thư đi
...
<p><img src="http://hitskin.com/themes/16/32/01/i_msg_outbox.png" /><a href="/privmsg?folder=outbox"> Thư đã gửi
...
<p><img src="http://hitskin.com/themes/16/32/01/i_msg_savebox.png" /><a href="/privmsg?folder=savebox"> Hộp lưu trữ
...
<div class="module main" style="margin-top: 1em! important;"><div class="main-head"><div class="h3">Tùy chỉnh
...
<div class="main-content"><p><img src="http://i40.servimg.com/u/f40/16/80/27/29/user10.png" /><a href="/profile?mode=editprofile&amp;page_profil=informations"> Thông tin cá nhân
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/cog10.png" /><a href="/profile?mode=editprofile&amp;page_profil=preferences"> Quyền riêng tư
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/image10.png" /><a href="/profile?mode=editprofile&amp;page_profil=avatars"> Ảnh đại diện
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/text_s10.png" /><a href="/profile?mode=editprofile&amp;page_profil=signature"> Tạo chữ ký
...
<div class="module main" style="margin-top: 1em! important;"><div class="main-head"><div class="h3">Khác
...
<div class="main-content"><p><img src="http://i48.servimg.com/u/f48/16/58/89/73/user-g10.png" /><a href="/groups"> Hội nhóm diễn đàn
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/group10.png" /><a href="/profile?mode=editprofile&amp;page_profil=friendsfoes"> Danh sách bạn bè
...
<p><img src="http://i48.servimg.com/u/f48/16/58/89/73/facebo10.jpg" /><a href="/profile?mode=editprofile&page_profil=facebook"> Kết nối facebook
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/eye10.png" /><a href="/search?search_id=watchsearch"> Theo dõi bài viết
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/heart10.png" /><a href="/search?search_id=favouritesearch"> Bài viết ưa thích
...
<p><img src="http://i40.servimg.com/u/f40/16/80/27/29/page_e10.png" /><a href="/search?search_id=draftsearch"> Dự thảo
...
')}$(".pun-crumbs").hide();$("#pun-navlinks  a.mainmenu[href='/search']").removeAttr("onclick").click(function(){$(this).parent().css("position","relative");$("#search_menu").css({"top":"30px","left":"-7px"}).slideToggle();return false});$(".subforumFMvi a").each(function(){$(this).replaceWith('<option value="'+$(this).attr("href")+'">• '+$(this).text()+'

Unknown end tag for &lt;/option&gt;

')});$(".subforumFMvi option").each(function(){$(this).appendTo($(this).parent().prev())});$(".subforumFMvi").each(function(){if($(this).text()==""){$(this).prev().remove();$(this).remove()}else{$(this).prev().show()}});$("a[href*='?showpost=']").click(function(){openWin($(this).attr("href"),1000,500);return false});if(location.search.slice(1,9)=='showpost'){$('.fmviToggle, #pun-visit, .main-foot, .main-head, .paged-head, .paged-foot, .pun-crumbs, #ptrafic_close, #ptrafic_open, #pun-about, #fa_ticker_block, #left, #pun-intro, #first-post-br, #pun-info, .autohidepost, .khoang').hide();var post=location.search.slice(10);if(post=="first"){$("#main .post:not(':first')").hide()}else if(post=="last"){$("#main .post:not(':last')").hide()}else{$("#main .post").not($("#p"+post).parents(".post")).hide()};$("#pun-foot p").prepend('<div align="center"><a href="javascript:window.close();"><strong class="closeWIndowF">Đóng cửa sổ này lại
...
')};var i;for(i=0;i<$(".boxFMvi").length;i++){if($(".boxFMvi:eq("+i+")").find("img[src='http://r20.imgfast.net/users/2012/10/88/45/album/forum_11.gif']").length>0){$(".boxFMvi:eq("+i+") .main-head").css("background-color","RED")}else if($(".boxFMvi:eq("+i+")").find("img[src='http://r20.imgfast.net/users/2012/10/88/45/album/lock_i10.jpg']").length>0){$(".boxFMvi:eq("+i+") .main-head").css("background-color","#000")}}var partname=location.pathname.slice(1,5);$("div.page-title h2").prepend('<span class="collapse" style="float:right"><a href="javascript:void(0);" alt="fmClose">-
...
.fancybox-inner{width:100%;height:100%;position:relative;outline:0;overflow:hidden;margin:0;padding:0}
...
#fancybox-loading{position:fixed;top:50%;left:50%;margin-top:-21px;margin-left:-21px;width:42px;height:42px;background:url(/users/2012/10/88/45/album/fancyb10.gif);opacity:.8;cursor:pointer;z-index:1010}
.fancybox-close,.fancybox-prev span,.fancybox-next span{background-image:url(/users/2012/10/88/45/album/fancyb10.png)}
.fancybox-close{position:absolute;top:-18px;right:-18px;width:36px;height:36px;cursor:pointer;z-index:1004}
.fancybox-prev,.fancybox-next{position:absolute;top:0;width:40%;height:100%;cursor:pointer;background:transparent url(/users/2012/10/88/45/album/blank110.gif);z-index:1003}
...
#fancybox-buttons a{display:block;width:30px;height:30px;text-indent:-9999px;background-image:url(/users/2012/10/88/45/album/fancyb11.png);background-repeat:no-repeat;outline:0}
...
.post-entry{background:transparent url(http://dealer.vn/js/ad_styler/1.0/imgs/bgs/noise_1.png) repeat-x}
.entry-content img{max-width:400px}
.iconPlayer{background:url(/users/2012/10/88/45/album/play-o10.png) no-repeat scroll center center transparent;left:160px;opacity:.8;position:absolute;top:-165px;z-index:99;padding:40px!important}
