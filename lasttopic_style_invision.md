...
Bạn tạo một file javascript đặt In all the pages:
...
Tạo một widgets tên là Lastinvision với content như sau:
...
Sắp xếp widgets: Topposter ► Lastinvision ► Most viewed topics
