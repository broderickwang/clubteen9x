...
**Các chức năng mới trong ver.2:**
  ...
  * Thêm bảng tùy chỉnh chi tiết:
    ...
    1. Lựa chọn Transparent cho toàn forum (mặc định không chọn).
...
Do CSS được chạy ngay khi tải (ver.1 là dùng javascript chạy sau khi tải trang) nên hiển thị nhanh hơn.
Xem các ver cũ ~ http://invision.chinhphuc.info/t196-topic#991 và http://invision.chinhphuc.info/t358-topic#2030
...
Vậy là xong Smile
Các bạn ra ngoài và hưởg thụ thành quả thôi Mắc cỡ

Mod by baivong - fmvi
Convert by miamor - IFC