...
Tính năng:
**Nhẹ** Color picker và Smileys không chuyển trang
**Multi-themes và Others** Custom commands
...
2) Vào Display >> Template >> General >> overall\_header >> Tìm

```

<!-- BEGIN switch_desc -->
<p id="pun-desc">{switch_desc.SITE_DESCRIPTION}
...
<div id="smiliebox" style="display:none">

Unknown end tag for &lt;/div&gt;

<div id="cbcolor" style="display:none">
...
<option id="h13" value="h13">phpBB3

Unknown end tag for &lt;/option&gt;


<option id="h14" value="h14">Invision
...
<div style="display:none;cursor:pointer;position:absolute;left:200px" onclick="ajax_refresh_chatbox('?archives=1', 1)">Refresh
...
Others:&nbsp;
<select id="cbbbcode">
<option value="[sub][/sub]">Index

Unknown end tag for &lt;/option&gt;


<option value="[sup][/sup]">Exponent

Unknown end tag for &lt;/option&gt;


<option value="[spoiler][/spoiler]">Spoiler

Unknown end tag for &lt;/option&gt;


<option value="[scroll][/scroll]">Horizontal Scrolling

Unknown end tag for &lt;/option&gt;


<option value="[updown][/updown]">Vertical Scrolling
