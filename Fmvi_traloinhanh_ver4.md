![http://i12.servimg.com/u/f12/17/70/81/78/1-16-210.png](http://i12.servimg.com/u/f12/17/70/81/78/1-16-210.png)


Thay code sau vào Templates viewcomments\_body
```
...
<!-- BEGIN no_comment -->
<div class="post">
<div onclick="repblog(this);" class="postbody no_comment butrepblog" style="margin-left: 34px;"><p style="text-align: center; float: none; font-size: 15px; padding: 20px 0px ! important;" class="button">Hãy là người đầu tiên bình luận blog này!
...
<script type="text/javascript" src="http://goo.gl/sGRkr">
...
<p class="h2" style="width: 220px !important">Bài viết liên quan:
...
&nbsp;<span class='bloglike' style='color:#FF66CC'>"+f+"
...
&nbsp;<span class='blogdlike' style='color:#009933'>"+h+"
...
&nbsp;<span class='blogtlike' style='color:#FF6600'>"+k+"
...
").fadeIn(300);d.find(".voteStar:lt("+a+")").addClass(b);d.find(".voteStar:eq("+c+")").addClass(g)}```