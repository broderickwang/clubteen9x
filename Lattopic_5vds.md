Demo online:
http://gunprivate.5forum.net/


Thay toàn bộ:
search\_results\_topics bằng code sau:
...
Cho code này vào đầu index\_body
```
...
<div class="main-content" style="margin: 1px; width: 915px;">
...
Thay toàn bộ mod\_most\_active\_topics bằng code sau

```

<div class="module main">
<div class="main-head"><div class="h3">Trả lời nhiều nhất
...
<span class="leftrecent" style="width:222px!important"><a href="{TOPIC.LINK}" onmouseover="show_tooltip(this, $(this).parent().next().html(), 'FMvi.vn')" title="{TOPIC.NAME}">
{TOPIC.NAME}
...
<div class="module main recentWidth" style="border:2px solid #DDD!important;height:384px">
...
<div id="last-posts"><div id="option-lastpost"><div class="op-last op-last2" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*', '22', '#recentnew ul')" title="Tải Lại Bảng Thống Kê Bài Mới"><img src="http://i44.servimg.com/u/f44/17/54/81/09/playba10.png" width="15px" height="15px"> F5 

Unknown end tag for &lt;/div&gt;

  <div class="op-last" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*&search_where=f11&search_time=0&show_results=topics&sort_by=0&sort_dir=DESC', '22', '#recentnew ul')"><font color="red">Gunny Lậu
...
<div class="op-last" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*&search_where=f79&search_time=0&show_results=topics&sort_by=0&sort_dir=DESC', '22', '#recentnew ul')"><font color="red">TH-Code
...
<code>
<div class="module main">
<div class="main-head"><div class="h3">Thành viên tích cực
