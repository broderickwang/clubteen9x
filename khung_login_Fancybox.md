...
http://nq5.upanh.com/b3.s28.d2/6dab8d719ca5af0484e090a9000b85c0_48511245.2.bmp
...
<div id="funybox" style="left: 0px; display: none; "><div id="loginbox" class="window login_menu"><div class="loginbox_content"><div class="loginbox_head"><strong>Đăng nhập
...
<form action="/login" method="post" name="form_login"><div class="loginbox_username"><label for="username">Tên đăng nhập
...
<div class="loginbox_password"><label for="password">Mật khẩu

Unknown end tag for &lt;/label&gt;

 <input id="quick_login_password" name="password" type="password"><span class="forgot right"><a class="pmpopup" href="/profile?mode=sendpassword" id="resend_password_link">Quên mật khẩu
...
<br class="clearboth"><div class="loginbox_submit"><input type="checkbox" name="autologin" id="autologin" tabindex="4" class="checkbox" checked="checked"><label>Ghi nhớ
...
<div class="loginbox_submit_button"><input id="signin_submit_remember" name="login" type="submit" value="Đăng nhập">
...
<div id="rep-mail-bar"><div class="kingforuser"><a href="/register"><img src="http://i30.servimg.com/u/f30/17/60/71/24/ky10.png" title="Đăng ký">
