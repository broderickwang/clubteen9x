...
{NAV_CAT_DESC}&nbsp;&raquo;&nbsp;<strong>{L_NEW_OR_EDIT_POST}
...
<dl>
<dt><label>{switch_privmsg.switch_privmsg_friend.L_OR_FRIEND}
...
<dl>
<dt><label>{switch_privmsg.switch_privmsg_group.L_OR_GROUP}
...
<dl>
<dt style="padding-top:14px"><label>{L_ICON_TITLE}
...
<br />
<button style="font-family:Papyrus" onclick="bbfontstyle('[font=Papyrus]','[/font]');selectWysiwyg(this,'font');return false">Papyrus

Unknown end tag for &lt;/button&gt;

<br />
<button style="font-family:Pristina" onclick="bbfontstyle('[font=Pristina]','[/font]');selectWysiwyg(this,'font');return false">Pristina
...
<br />
<button onclick="bbfontstyle('[spoiler]','[/spoiler]');selectWysiwyg(this,'other');return false">{L_BBCODE_SPOILER}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[hide]','[/hide]');selectWysiwyg(this,'other');return false">{L_BBCODE_HIDE}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[scroll]','[/scroll]');selectWysiwyg(this,'other');return false">{L_BBCODE_K}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[updown]','[/updown]');selectWysiwyg(this,'other');return false">{L_BBCODE_UPDOWN}
...
<div style="visibility:hidden" class="select" id="notes">
<button onclick="bbfontstyle('<div class=noteclassic>','</div>');selectWysiwyg(this,'notes');return false"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/note1.png">Classic note

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('<div class=notetip>','</div>');selectWysiwyg(this,'notes');return false"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/tip1.png">Tip note

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('<div class=notewarning>','</div>');selectWysiwyg(this,'notes');return false"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/warning1.png">Warning note

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('<div class=noteimportant>','</div>');selectWysiwyg(this,'notes');return false"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/important1.png">Important note

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('<div class=notehelp>','</div>');selectWysiwyg(this,'notes');return false"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/help1.png">Help note
...
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" /> <wbr/>
<button class="button2" onclick="selectWysiwyg(this,'px')" onmouseover="helpline('f')" type="button"><img src="{PATH_IMG_FA}wysiwyg/style.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onclick="selectWysiwyg(this,'color')" onmouseover="helpline('s')" type="button"><img src="{PATH_IMG_FA}wysiwyg/color_swatch.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onclick="selectWysiwyg(this,'font')" onmouseover="helpline('ft')" type="button"><img src="{PATH_IMG_FA}wysiwyg/font.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onmouseover="helpline('xy')" onclick="bbfontstyle('[img]http://www.codecogs.com/eq.latex?','[/img]');return false" type="button"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/math.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onclick="selectWysiwyg(this,'notes')" onmouseover="helpline('nt')" type="button"><img src="http://i913.photobucket.com/albums/ac332/battuvuong/baivong/inote.gif" />
...
<!-- END switch_roll_dice_old -->
<button class="button2" onclick="window.open('http://{URL_FORUM}/faq.htm?mode=bbcode')" type="button"><img src="{PATH_IMG_FA}wysiwyg/help.png" />
...
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" /> <wbr/>
<button class="button2" onclick="selectWysiwyg(this,'wpx')" onmouseover="helpline('f')" type="button"><img src="{PATH_IMG_FA}wysiwyg/style.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onclick="selectWysiwyg(this,'wcolor')" onmouseover="helpline('s')" type="button"><img src="{PATH_IMG_FA}wysiwyg/color_swatch.png" />

Unknown end tag for &lt;/button&gt;


<button class="button2" onclick="selectWysiwyg(this,'wfont')" onmouseover="helpline('ft')" type="button"><img src="{PATH_IMG_FA}wysiwyg/font.png" />
...
<a href="#" onClick="window.open('http://upanh.com/','_blank','width=600,height=400')"><button class="button2" type="button" title="Đăng ảnh lên upanh.com"><img src=http://i913.photobucket.com/albums/ac332/battuvuong/baivong/VZ011093924_29781_1.png></button></a>
<a href="#" onClick="window.open('http://www.mediafire.com/','_blank','width=600,height=400')"><button class="button2" type="button" title="Tải tập tin lên mediafire"><img src=http://i913.photobucket.com/albums/ac332/battuvuong/baivong/E8011093331_29781_1.png></button></a>
<a href="#" onClick="window.open('http://mp3.zing.vn/','_blank','width=600,height=400')"><button class="button2" type="button" title="Nghe nhạc từ mp3.zing.vn"><img src=http://i913.photobucket.com/albums/ac332/battuvuong/baivong/3L011093325_29781_1.png></button></a>
<a href="#" onClick="window.open('http://www.youtube.com/','_blank','width=600,height=400')"><button class="button2" type="button" title="Tải xuống video từ youtube.com"><img src=http://i913.photobucket.com/albums/ac332/battuvuong/baivong/3K011093455_29781_1.png></button></a>


<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" /> <wbr/>
<button class="{BUTTON_WYSI_STYLE}" id="text_editor_cmd_switchmode" type="button"><img src="{PATH_IMG_FA}i/switch_wysiwyg.gif" alt="{SWITCH_EDITOR_MODE}" />
...
<textarea id="text_editor_textarea" class="post" style="width:100%;height:250px" onclick="storeCaret(this)" onkeyup="storeCaret(this)" name="message" rows="15" cols="35" tabindex="3" onselect="storeCaret(this)" wrap="virtual">{MESSAGE}
...
<td align="center"><span class="gen"><b><font color=#fff>{ROLL_DICE_TITLE}</font></b></span></td><td width="10"><a href="javascript:ShowHideLayernew('rolldice')"><img src="{TABS_MORE_IMG}" alt="+" align="middle" border="0">
...
<td align="center"><span class="gen"><b><font color=#fff>{ROLL_DICE_TITLE}</font></b></span></td>
...
<span class="postbody"> <label for="nb_rolls">{switch_roll_dice.L_DICE_ROLLS} : 

Unknown end tag for &lt;/label&gt;

<input type="text" size="2" maxlength="3" name="nb_rolls_' + dice_number + '" id="nb_rolls" class="post" value="' + number + '" /> <span id="dice_to_del"><a href="javascript:add_dice(' + (dice_number + 1) + ','',1)"><img src="{PATH_IMG_FA}tabs_more.gif" alt="plus" />
...
<input type="text" size="2" maxlength="3" name="nb_rolls_0" id="nb_rolls" class="post" value="{switch_roll_dice.S_DICE_ROLLS_VALUE}" />
...
<!-- BEGIN attachments -->
<dl>
<dt><label>{L_ATTACHMENT_FILENAME}
...
<dt><label for="filecomment{switch_attachment_list.attachments.ATTACH_POS}">{L_ATTACH_COMMENT}
...
<div class="main-content frm">
<fieldset class="frm-set multi">
{L_ATTACHMENT_ADD_HELP}<br /><span class="info">{EXT_LIST}
...
<dl>
<dt><label for="fileupload">{L_ATTACHMENT_FILENAME}
...
<dl>
<dt><label for="filecomment">{L_ATTACH_COMMENT}
...
<!-- END switch_icon_checkbox -->
<dl>
<dt><label for="modif_topic_title">{L_TOPIC_TITLE_MODIFY}
