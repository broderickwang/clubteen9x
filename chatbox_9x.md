...
<b><font color="violet"/><a href="http://danchoi9x.123.st/t105-topic" target="blank">Tuyển cộng tác viên [ Đợt 1 ]
...
<div class="buzza1" id="chatbox" style="height: 285px; ">
...
Bước 2 : vào index\_body tìm {CHATBOX\_TOP} xoá vào chèn code này vào

```

<script type="text/javascript">jQuery(document).ready(function(){my_setcookie('mytid',jQuery("#logout").attr("href"),1,0);});

Unknown end tag for &lt;/script&gt;


<object data="Link HTML bạn tạo vừa nãy" scrolling="yes" width="100%" height="400px" type="text/html">
...
( không thì ném code vào đầu index\_body cũng được)
...
bán tìm từ <div> ( k biết thì nhấn Ctr+f nhá Tìm kiếm đi )<br>
và xoá các phần ở trước nó<br>
<br>
<img src='http://i44.servimg.com/u/f44/15/64/85/86/menu_410.jpg' />

phần khoanh màu đỏ là phần cần xoá<br>
tiếp tục tìm emoticonp xoá và thay thành emoticon ( bỏ chữ p sau cùng cũng được)<br>
cái này bạn càng chèn nhiều hình vui thì phải thay nhiều nhá<br>
chưa hết đâu. bạn cứ tiếp tục tìm và xoá khi nào tìm mà nó k hiện kết quả nữa thì thôi<br>
xong. nhấn Submit<br>
Bước 4 quay lại trang HTML bạn tạo có tên là chatbox lúc nãy tìm /h2- ( k biết thì nhấn Ctr+f nhá Tìm kiếm đi ) xoá nó đi và thay thành link HTML emotion bạn vừa tạo. --> Submit<br>
xong thoát ra và thưởng thức<br>
bạn nào còn không làm được thì pm yahoo mình<br>
nhinevsno_nhu2condog@yahoo.com<br>
suýt quên demo đây :<br>
<br>
<img src='http://i44.servimg.com/u/f44/15/64/85/86/menu_411.jpg' />
