demo : http://4rbizgame.123.st/ ( vào chụp cái ảnh luôn cái )

![http://i16.servimg.com/u/f16/17/22/61/18/647a7c10.jpg](http://i16.servimg.com/u/f16/17/22/61/18/647a7c10.jpg)
...
<div id="last-posts"><div id="option-lastpost"><div class="op-last op-last2" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*', '19', '#recentnew ul')" title="Tải Lại Bảng Thống Kê Bài Mới"><img src="http://i43.servimg.com/u/f43/16/03/04/56/reload11.png" width="15px" height="15px"> F5 

Unknown end tag for &lt;/div&gt;

  <div class="op-last" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*&search_where=f3&search_time=0&show_results=topics&sort_by=0&sort_dir=DESC', '19', '#recentnew ul')">Gunny Lậu

Unknown end tag for &lt;/div&gt;

<div class="op-last" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*&search_where=f24&search_time=0&show_results=topics&sort_by=0&sort_dir=DESC', '19', '#recentnew ul')">HD-Code

Unknown end tag for &lt;/div&gt;

<div class="op-last" onclick="javascript:searchtopic('/search?search_keywords=&search_author=*_*&search_where=f25&search_time=0&show_results=topics&sort_by=0&sort_dir=DESC', '19', '#recentnew ul')">Hỏi Đáp
...
<div class="op-change"><div class="op-prew">
...
<span style="margin-right: 5px;" class="rightrecent">Người gửi

Unknown end tag for &lt;/span&gt;


<span class="viewfmvi" style="margin-right: 1px;">Xem

Unknown end tag for &lt;/span&gt;


<span style="margin-right: -20px;" class="repfmvi">Trả lời

Unknown end tag for &lt;/span&gt;


<span style="margin-right: 10px;" class="lastcate">Chuyên mục
...
<center><h2>-‘๑’-Thống Kê Bài Viết -‘๑’-
...
<div class="op-last-bottom op-last-bottom2" onclick="javascript:searchtopic('/search?search_author=*_*&search_keywords', '20', '#recentnew ul')">Bài gửi sau cùng

Unknown end tag for &lt;/div&gt;


<div class="op-last-bottom" onclick="javascript:searchtopic('/search?search_id=newposts', '20', '#recentnew ul')">Bài từ lần truy cập trước

Unknown end tag for &lt;/div&gt;


<div class="op-last-bottom" onclick="javascript:searchtopic('/search?search_id=egosearch', '20', '#recentnew ul')">Bài bạn đã tham gia thảo luận

Unknown end tag for &lt;/div&gt;



<div class="op-last-bottom" onclick="javascript:searchtopic('/search?search_id=unanswered', '20', '#recentnew ul')">Bài chưa ai trả lời
...
js last 2 [page](Home.md) >>> cái này tao động khi rê chuột :
...
$(this).find('td:first a.gensmall').appendTo('#main-lastpost .dl-post:last').wrap('<span class="lp3">
