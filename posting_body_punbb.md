...
<p class="center">{switch_quote_limit.L_QUOTE_LIMIT_WARNING}
...
<div class="main-head clearfix">
<p class="h2"><!-- BEGIN switch_post_a -->{L_POST_A}<!-- END switch_post_a -->

Unknown end tag for &lt;/p&gt;


<p class="options">
<a class="exthelp" title="{L_HELP}" href="http://{URL_FORUM}{U_FAQ}" target="_blank">{L_BBCODE_GUIDE}
...
<script src="http://camxuc9x.yourme.net/49967.js" type="text/javascript">
...
<dd><input type="text" name="username"  maxlength="8" value="{USERNAME}" />
...
<dl>
<dt><label>Hoặc cho một người bạn
...
<dd>{switch_privmsg.switch_privmsg_friend.FRIEND_PM}
...
<dl>
<dt style="padding-top:14px"><label>Biểu tượng: 
...
<span onclick="document.forms['post'].post_icon_{switch_icon_checkbox.row.cell.ICON_ID}.checked=true">{switch_icon_checkbox.row.cell.ICON_IMG}
...
<input type="button" value="[Thông báo]" onclick="set_solved(this.form.elements['subject'],'[Thông báo] ')" style="display:none" id="button_ask" />
<script type="text/javascript">document.getElementById('button_ask').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Clip]" onclick="set_solved(this.form.elements['subject'],'[Clip] ')" style="display:none" id="yyy" />
<script type="text/javascript">document.getElementById('yyy').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Ảnh]" onclick="set_solved(this.form.elements['subject'],'[Ảnh] ')" style="display:none" id="rrr" />
<script type="text/javascript">document.getElementById('rrr').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Music]" onclick="set_solved(this.form.elements['subject'],'[Music] ')" style="display:none" id="wet" />
<script type="text/javascript">document.getElementById('wet').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Truyện]" onclick="set_solved(this.form.elements['subject'],'[Truyện] ')" style="display:none" id="www" />
<script type="text/javascript">document.getElementById('www').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Hỏi]" onclick="set_solved(this.form.elements['subject'],'[Hỏi]')" style="display:none" id="zzz" />
<script type="text/javascript">document.getElementById('zzz').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Code]" onclick="set_solved(this.form.elements['subject'],'[Code] ')" style="display:none" id="tyt" />
<script type="text/javascript">document.getElementById('tyt').style.display = 'inline';

Unknown end tag for &lt;/script&gt;


<input type="button" value="[Xóa]" onclick="set_solved(this.form.elements['subject'],'[Xóa]')" style="display:none" id="t9" />
<script type="text/javascript">document.getElementById('t9').style.display = 'inline';
...
<dd class="frm-input">
<input type="text" style="width:450px" name="subject" value="{SUBJECT}" title="{TOPIC_TITLE_LENGTH_EXPLAIN}" onkeypress="if (event.keyCode==13){return false}" id="maxkytu" maxlength="70" />
[<span id="counter_number" class="counter">70
...
<input type="text" autocomplete="off" class="inputbox medium" id="table_gui_cols" maxlength="3" style="width:20px" title="{L_COLS}" onkeypress="if (event.keyCode==13){ bbstyle_table();selectWysiwyg(this,'table_gui');return false}" />&nbsp;&nbsp;<input type="button" class="button2" onclick="bbstyle_table();selectWysiwyg(this,'table_gui')" value="{L_OK}" />
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="img_url" title="{L_URL}" onkeypress="if (event.keyCode==13){constructBBcode('img','','img_url');selectWysiwyg(this,'img');return false}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><input type="button" class="button2" onclick="constructBBcode('img','','img_url');selectWysiwyg(this,'img')" value="{L_OK}" />
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="link_url" title="{L_URL}" onkeypress="if (event.keyCode==13){constructBBcode('url',new Array('link_url'),'name_url');selectWysiwyg(this,'url');return false}" />

Unknown end tag for &lt;/p&gt;


<p><img src="{PATH_IMG_FA}wysiwyg/link_text.png" alt="{L_LABEL}" title="{L_LABEL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="name_url" title="{L_LABEL}" onkeypress="if (event.keyCode==13){constructBBcode('url',new Array('link_url'),'name_url');selectWysiwyg(this,'url');return false}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><input type="button" class="button2" onclick="constructBBcode('url',new Array('link_url'),'name_url');selectWysiwyg(this,'url')" value="{L_OK}" />
...
&nbsp; <a href="http://www.video.google.com/" target="_blank"><img src="{PATH_IMG_FA}wysiwyg/googlevideo.gif" alt="Google Video" title="Google Video" style="vertical-align:middle" />Google Video
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:300px" id="video_url" title="{L_URL}" onkeypress="if (event.keyCode==13){BBcodeVideo('video_url');return false}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><input type="button" class="button2" onclick="BBcodeVideo('video_url')" value="{L_OK}" />
...
<p style="text-align:center"><input type="button" class="button2" onclick="constructBBcode('flash',new Array('flash_width','flash_height'),'flash_url');selectWysiwyg(this,'flash')" value="{L_OK}" />
...
<br />
<button style="color:white" onclick="bbfontstyle('[color=white]','[/color]');selectWysiwyg(this,'color');return false">{L_COLOR_WHITE}
...
<button onclick="bbfontstyle('[sub]','[/sub]');selectWysiwyg(this,'other');return false">{L_BBCODE_SUB}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[sup]','[/sup]');selectWysiwyg(this,'other');return false">{L_BBCODE_SUP}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[spoiler]','[/spoiler]');selectWysiwyg(this,'other');return false">Thu gọn

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[hide]','[/hide]');selectWysiwyg(this,'other');return false">Ẩn bài

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[scroll]','[/scroll]');selectWysiwyg(this,'other');return false">Chữ phải sang trái

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[updown]','[/updown]');selectWysiwyg(this,'other');return false">Chữ dưới lên trên

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[blur]','[/blur]');selectWysiwyg(this,'other');return false">Chữ sương mù

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[fade]','[/fade]');selectWysiwyg(this,'other');return false">Chữ mờ dần

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[fliph]','[/fliph]');selectWysiwyg(this,'other');return false">Chữ ngược

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[flipv]','[/flipv]');selectWysiwyg(this,'other');return false">Đảo ngược văn bản

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[rand]','[/rand]');selectWysiwyg(this,'other');return false">{L_BBCODE_RAND}

Unknown end tag for &lt;/button&gt;

<br />
<button onclick="bbfontstyle('[wow]','[/wow]');selectWysiwyg(this,'other');return false">{L_BBCODE_WOW}
...
&nbsp;&nbsp;<button class="button2" id="text_editor_cmd_constructBBcode_table">{L_OK}
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="wimg_url" title="{L_URL}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><button class="button2" id="text_editor_cmd_constructBBcode_img">{L_OK}
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="wlink_url" title="{L_URL}" />

Unknown end tag for &lt;/p&gt;


<p><img src="{PATH_IMG_FA}wysiwyg/link_text.png" alt="{L_LABEL}" title="{L_LABEL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="wname_url" title="{L_LABEL}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><button class="button2" id="text_editor_cmd_constructBBcode_url">{L_OK}
...
&nbsp;x&nbsp;<img src="{PATH_IMG_FA}wysiwyg/height.png" alt="{L_HEIGHT}" title="{L_HEIGHT}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:25px" id="wflash_height" title="{L_HEIGHT}" />&nbsp; px

Unknown end tag for &lt;/p&gt;


<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:150px" id="wflash_url" title="{L_URL}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><button class="button2" id="text_editor_cmd_constructBBcode_flash">{L_OK}
...
<p><img src="{PATH_IMG_FA}wysiwyg/link.png" alt="{L_URL}" title="{L_URL}" style="vertical-align:middle" />&nbsp;<input type="text" autocomplete="off" class="inputbox" style="width:300px" id="wvideo_url" title="{L_URL}" />

Unknown end tag for &lt;/p&gt;


<p style="text-align:center"><button class="button2" id="text_editor_cmd_constructBBcode_video">{L_OK}
...
<br />
<button style="color:white" id="text_editor_cmd_constructBBcode_select_color_white">{L_COLOR_WHITE}
...
<button id="text_editor_cmd_constructBBcode_select_action_sub">{L_BBCODE_SUB}

Unknown end tag for &lt;/button&gt;

<br />
<button id="text_editor_cmd_constructBBcode_select_action_sup">{L_BBCODE_SUP}
...
&nbsp;
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" />&nbsp;
<button class="button2" onmouseover="helpline('Kí hiệu toán học')" onclick="bbfontstyle('http://www.codecogs.com/eq.latex?','');return false" type="button"><img src="http://i20.servimg.com/u/f20/15/90/59/25/math1010.png" height="16">

Unknown end tag for &lt;/button&gt;

&nbsp;
<button class="button2" onmouseover="helpline('Nút Download')" onclick="bbfontstyle('[url=',']http://i20.servimg.com/u/f20/15/90/59/25/downlo10.gifBấm vào đây để tải về[/url]');return false" type="button"><img src="http://i20.servimg.com/u/f20/15/90/59/25/downlo10.gif" height="16">
...
<!-- END switch_roll_dice_old -->
<button class="button2" onclick="window.open('http://{URL_FORUM}/faq.htm?mode=bbcode')" type="button" title="{L_BBCODE_HELP}"><img src="{PATH_IMG_FA}wysiwyg/help.png" alt="{L_BBCODE_HELP}" />

Unknown end tag for &lt;/button&gt;

&nbsp;
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" />&nbsp;
<a onmouseover="helpline('a')" href="javascript:bbstyle(-1)">{L_BBCODE_CLOSE_TAGS}
...
<button class="button2" onmouseover="helpline('b')" type="button" id="text_editor_cmd_bold" accesskey="b" title="{L_BBCODE_B}"><img src="{PATH_IMG_FA}wysiwyg/text_bold.png" alt="{L_BBCODE_B}" />
...
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" />&nbsp;
<!-- BEGIN switch_roll_dice_old -->
<button class="button2" onclick="selectWysiwyg(this,'wdices')" type="button"><img src="{PATH_IMG_FA}wysiwyg/dice.gif" />
...
<img src="{PATH_IMG_FA}wysiwyg/separator.png" style="vertical-align:middle" />&nbsp;
<button class="{BUTTON_WYSI_STYLE}" id="text_editor_cmd_switchmode" type="button" title="{SWITCH_EDITOR_MODE}"><img src="{PATH_IMG_FA}i/switch_wysiwyg.gif" alt="{SWITCH_EDITOR_MODE}" />
...
<div class="left"><span id="helpbox" class="helpline">
...
<dl>
<dt><label for="text_editor_textarea">{L_MESSAGE}
...
<textarea id="text_editor_textarea" onclick="storeCaret(this)" rows="15" cols="9" onkeyup="storeCaret(this)" name="message" tabindex="3" onselect="storeCaret(this)" wrap="virtual" style="width:98%">{MESSAGE}
...
<br />
<dl>
<dt><label><span style="font-size:11px">{edit_reason.L_EDIT_REASON}
...
<dd><input class="inputbox medium" style="width:63%" type="text" name="edit_reason" value="{edit_reason.EDIT_REASON}" maxlength="255">
...
<div class="main-head clearfix">{ROLL_DICE_TITLE}
...
new_tr.firstChild.innerHTML = '{ROLL_DICE_TITLE_LOW} #' + (dice_number + 1) + ' :&nbsp;<select name="post_dice_' + dice_number + '" id="post_dice_' + dice_number + '" value="' + dice + '">' + content + '

Unknown end tag for &lt;/select&gt;

&nbsp;<label for="nb_rolls">{switch_roll_dice.L_DICE_ROLLS} : 

Unknown end tag for &lt;/label&gt;

<input type="text" size="2" maxlength="3" name="nb_rolls_' + dice_number + '" id="nb_rolls" value="' + number + '" />&nbsp;<span id="dice_to_del"><a href="javascript:add_dice(' + (dice_number + 1) + ',\'\',1)"><img src="{PATH_IMG_FA}tabs_more.gif" alt="plus" />
...
<dt><label for="filecomment{switch_attachment_list.attachments.ATTACH_POS}">Mô tả
...
<dd class="frm-input">
<!--textarea name="comment_list[{switch_attachment_list.attachments.ATTACH_POS}]" cols="35" rows="3" style="color:#000000;width:100%">{switch_attachment_list.attachments.ATTACH_COMMENT}
...
<div class="main-content frm">
<fieldset class="frm-set multi">
Bạn có thể đính kèm một hay nhiều tập tin với các đuôi sau đây:
...
<br /><br />
<dl>
<dt><label for="fileupload">Tên tệp
...
<dd><input type="file" id="fileupload" name="fileupload" /><input type="submit" name="add_file" /> ({L_MAX_ATT_SIZE})
...
<dl>
<dt><label for="filecomment">Mô tả: 
...
<dd class="frm-input"><input type="text" id="filecomment" name="filecomment" value="" maxlength="255" />
...
<label><input type="checkbox" name="disable_html"{S_HTML_CHECKED} />&nbsp;{L_DISABLE_HTML}
...
<label><input type="checkbox" name="disable_bbcode"{S_BBCODE_CHECKED} />&nbsp;{L_DISABLE_BBCODE}
...
<label><input type="checkbox" name="disable_smilies"{S_SMILIES_CHECKED} />&nbsp;{L_DISABLE_SMILIES}
...
<label><input type="checkbox" name="attach_sig"{S_SIGNATURE_CHECKED} />&nbsp;{L_ATTACH_SIGNATURE}
...
<label><input type="checkbox" name="notify"{S_NOTIFY_CHECKED} />&nbsp;{L_NOTIFY_ON_REPLY}
...
<label><input type="checkbox" name="delete" />&nbsp;{L_DELETE_POST}
...
<!-- END switch_icon_checkbox -->
<dl>
<dt><label for="modif_topic_title">Sửa đổi tiêu đề topic: 
...
<a href="javascript:void(0)" style="font-style:normal;font-weight:normal" onclick="document.post.topic_calendar_day.value={TODAY_DAY};document.post.topic_calendar_month.value={TODAY_MONTH};document.post.topic_calendar_year.value={TODAY_YEAR}">{L_TODAY}
...
<input name="topic_calendar_min" type="text" maxlength="2" value="{CALENDAR_MIN}" />&nbsp;Phút
