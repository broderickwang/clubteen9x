...
Demo:
![http://i12.servimg.com/u/f12/17/70/81/78/12-28-10.png](http://i12.servimg.com/u/f12/17/70/81/78/12-28-10.png)
![http://i12.servimg.com/u/f12/17/70/81/78/12-29-10.jpg](http://i12.servimg.com/u/f12/17/70/81/78/12-29-10.jpg)
![http://i12.servimg.com/u/f12/17/70/81/78/12-29-11.jpg](http://i12.servimg.com/u/f12/17/70/81/78/12-29-11.jpg)
![http://i12.servimg.com/u/f12/17/70/81/78/12-29-10.png](http://i12.servimg.com/u/f12/17/70/81/78/12-29-10.png)
...
');
if ($(".entry-content a[href*='www.youtube'][href*='v=']").length) {
...
$(this).replaceWith('<p class="fancy-ytb">' + d + '<a class="iconPlayer fancybox.iframe" href="' + c + '" rel="ytb-' + $(this).parents('.post').attr('id') + '" targe="_blank">

Unknown end tag for &lt;/a&gt;

<img class="fcim" alt="youtube" width="480" height="260" src="http://i3.ytimg.com/vi/' + a + '/0.jpg" />
...
$(".entry-content").find("a[href$='.jpeg'], a[href$='.bmp'], a[href$='.jpg'], a[href$='.png'],  a[href$='.gif']").not("a.vlightbox").not("a.iconPlayer").each(function () {
...
$(".main-content.topic").queryLoader2();
});
function fancyapp() {
$(".entry-content img").each(function () {
if (!/illiweb|smiles/i.test($(this).attr("src")) && $(this).height() > 100 && $(this).width() > 100) {
if ($(this).attr("class") != "fcim") {
$(this).wrap('<a rel="flb-' + $(this).parents('.post').attr('id') + '" class="vlightbox" href="' + $(this).attr("src") + '">
...
Lưu ý:
Gỡ toàn bộ CSS và javascript của fancybox đang dùng (hoặc các lightbox khác).
Xoá các dòng code sửa ảnh lỗi.
Không ẩn bài viết khi sao chép đi nơi khác.
Không được sửa dòng copyright, không được thay link www.fmvi.vn trong mã nguồn.