...
Khi click vào một ảnh trong topic thì nó ra thế này:
> ![http://vc9.upanh.com/thumbpic/24.270.31374688.x4L0/demo.700x0.jpg](http://vc9.upanh.com/thumbpic/24.270.31374688.x4L0/demo.700x0.jpg)
...
if($(this).height() > 120)
{
$(this).replaceWith('<a href="'+$(this).attr('src')+'" title="9/7 BHN No.1"><img  title="Click vào ảnh xem kích thước thật" src="'+$(this).attr('src')+'">
...
- Tiếp tục bấm vào dấu bên cạnh trang HTML
...
B3: Thêm đoạn codes trong overall\_header

- Bảng điều khiển => Display =>Templates => Quản lí tổng thể => Overall\_header =>
- Tìm:
