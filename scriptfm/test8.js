...
document.write('<td align="center" rowspan="100" width="32" style="background: #fff url(http://i832.photobucket.com/albums/zz244/a1tg3/lylich.jpg) no-repeat top left; border-left: 2px #ff3000 solid;" valign="'+barVAlign+'"><p align="center"><font face="'+barFontFamily+'" Size="'+barFontSize+'" COLOR="'+barFontColor+'"><B>'+tempBar+'</B></font></p></TD>')}
...
document.write('<table border="0" cellpadding="0" cellspacing="1" width="'+(menuWidth+barWidth+2)+'px" bgcolor="'+menuBGColor+'" style="border: 2px #ff3000 solid;">');
