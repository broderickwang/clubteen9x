/*
Power by 08 DB B Community - http://khoahoctunhien.2forum.biz
*/
...
config. Title			= 'Info'		// Default title text applied to all tips (no default title: empty string '')
config. TitleAlign		= 'left'	// 'left' or 'right' - text alignment inside the title bar
config. TitleBgColor	= '#003399'		// If empty string '', BorderColor will be used
