hi ngại quá đi cái vườn ước nguyện cũ hum trước mình nhỡ tay del mất lên lại phải làm lại từ đầu mà ngại sửa lại ghê lên làm qua loa đại khái lại :D
bạn nào mang về thấy lỗi j thì bảo nhé với cả có edit lại cho đẹp cũng dc
demo onl http://hotro59.forumvi.com/f3-forum
demo ảnh làm sau
nhược điểm của code này là sẽ ko sử dụng dc blog trong forum nữa :D
thui mấy phần nhược và ưu thì bạn tự tìm hiểu :D
code dây
...
<a  onmouseover="show_tooltip(this,'Ấn vào đây');" data-toggle="modal"  href="#myModal" ><img src="http://i45.servimg.com/u/f45/17/95/94/57/iyly10.png" width="170" height="48" vspace="30" border="0">
...
<div class="popper" id="topdeck" style="visibility: hidden;"> 
...
<right>
<div class="inf"> <div class="ava"><img src="http://i.imm.io/NzrN.png" >

Unknown end tag for &lt;/div&gt;

<div class="inf1"><p class="nam3">{topics_blog_box.row.TOPIC_AUTHOR}
...
<div class="user-info">
<a onmouseover="show_tooltip(this,'quan tâm : <font color=#FF66CC> {topics_blog_box.row.VIEWS}</font> <br> Gửi đến : <font color=red> {topics_blog_box.row.TOPIC_TITLE}</font> <br>NỘI DUNG : <font color=#FF66CC>BẠN CLICK ĐỂ XEM CHI TIẾT NHÉ</font>');"  href="{topics_blog_box.row.U_VIEW_TOPIC}"><span style="color:black"><strong>ƯỚC LÀ ...
...
<tr>
<td valign="top"><img src="http://i45.servimg.com/u/f45/17/95/94/57/notice10.png" width="230" height="245">
...
jQuery("#security").load("/post?f=3&mode=newtopic input[name^=auth]");
...
<br>
<a style="padding-right: 150px;font-size:14px;font-weight:bold;color:red"  onmouseover="show_tooltip(this,'Ấn vào đây');" data-toggle="modal"  href="#myModal" >comment

Unknown end tag for &lt;/a&gt;

 <a onmouseover="show_tooltip(this,'quay lại vườn ước nguyện');"  style="font-size:14px;font-weight:bold;color:red" href="/f{FORUM_ID}-">Quay lại 
...
mình nói trước rùi mình chỉ làm nhanh và test trên 1 forum thử chưa làm forum khác lên lỗi j các bạn trình bày lại nha :D